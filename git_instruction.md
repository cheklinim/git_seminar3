...
2 Найти необходимый репозиторий в GitHub. На странице репозитория нажать кнопку Fork, далее нажимаем кнопку Code, далее копируем ссылку необходимого репозитория;
...
4 Меняем папку, для чего вводим в терминале команду:
    ...
    cd .\имя папки\ (для Windows) или cd имя папки (для MacOS)
...
5 После завершения работы с репозиторием необходимо актылизировать локальный репозиторий с оригинальным репозиторием на GitHub. Это делается с помощью команды:
