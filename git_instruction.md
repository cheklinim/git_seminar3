...
Когда репо по этой ссылке найдется, то на панели инструментов нужно нажать кнопку с иконкой <fork>. Тут мы можем изменить имя файла и идти дальше нажав конпку <greate fork>.
...
Переходим в github, обновляем страницу. В окне выбора веток ищем свою которую создавали в терминале. Переключаемся, смотрим историю комитов и видим свой последний комит. Далее нажимаем кнопку <contribute> и будет доступна кнопка <open pull request> нажимаем ее. 

Вводим коментарии по поводу проделанной работы и нажимаем кнопку <grent pull request>
