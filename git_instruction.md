...
Находим необходимый проект по ссылке или через поисковое окно в GitHub. Нажимаем кнопку Fork и в нашем удалённом репозитории появляется клонированная копия данного проекта.

Теперь мы можем подтянуть данный проект к себе в git для работы над ним. После проведения изменений мы отправляем обратно в свой удалённый репозиторий. А уже оттуда отправляем запрос на принятие изменений в оригинальный проект нажатием на кнопку Compare & pull request.

Важный момент! Для работа над чужим проектом необходимо сначала создать отдельную ветку, а так же вложить текстовый фаил с описанием ваших изменений.
